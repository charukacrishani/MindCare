    ...
    return (
        <div className="w-full max-w-5xl mx-auto p-4 sm:p-6">
            <div className="mb-5 flex items-center justify-between">
                <h1 className="text-2xl sm:text-3xl font-semibold text-[#1d1d1f]">My Appointments</h1>
            </div>
                    ...
                    {appointments.map((appointment) => {
                        ...
                        return (
                            <Link
                                ...
                                key={appointment.id}
                                className="block rounded-2xl border border-[#e5e7eb] bg-white p-4 hover:border-[#d1d5db] hover:shadow-sm transition"
                            >
