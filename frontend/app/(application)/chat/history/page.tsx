    ...
    return (
        <div className="w-full h-full flex flex-col">
            <PageHeader
                ...
                description="Review your past conversations with the chatbot, track your progress, and reflect on your mental health journey."
            />

            {/* IMPORTANT: this must be flex-1 + min-h-0 */}
            <div className="flex-1 min-h-0 p-4 flex flex-col">
                {loading ? (
                    ...
                    <div className="flex flex-1 min-h-0 gap-4">
                        ...
                        {/* RIGHT PANEL */}
                        <div className="flex-1 min-w-0 flex flex-col border border-gray-100 rounded-xl bg-white shadow-sm overflow-hidden">
                                        ...
                                        message.sender === "bot" ? (
                                            <div key={message.id} className="flex justify-start">
                                                <div className="max-w-[75%] bg-white border border-gray-100 rounded-xl px-4 py-3 shadow-sm flex flex-col gap-2">
                                                    <div className="w-7 h-7 bg-white border border-gray-200 rounded-md flex items-center justify-center overflow-hidden">
                                                        <Image
                                            ...
                                            <div key={message.id} className="flex justify-end">
                                                <div className="max-w-[75%] rounded-xl px-4 py-3 shadow-sm flex gap-3 items-start bg-linear-to-r from-white from-70% via-[#FF96FC]/10 to-[#FF96FC]/20">
                                                    ...
                                                    <div className="w-7 h-7 rounded-full bg-[#FF96FC] flex items-center justify-center">
